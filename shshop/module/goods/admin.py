...
from shshop.models import ShShopCategory, ShShopSPU, ShShopSKU, ShShopSpec
from shshop.public.sites import sh_site

from shshop.module.goods.inline import (
    ShShopCategoryInline,
    ShShopSKUInline,
    ShSPUCarouselInline,
    ShShopSpecOptionInline,
)
...
mark_as_deleted.short_description = "删除"
...
class ShShopSPUAdmin(BaseModelAdmin):
    ...
    def dis_cover_pic(self, obj):
        return format_html(
            mark_safe("<img width='64px' height='64px' src='{}' />"), obj.cover_pic.url
        )
