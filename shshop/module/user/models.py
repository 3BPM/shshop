...
class UserInfo(AbstractModel):
    ...
    phone = models.CharField(max_length=11,
                             ...
                             null=True,
                             verbose_name="手机号")
    balance = models.DecimalField("余额",
                                  max_digits=8,
                                  blank=True,
                                  decimal_places=2,
                                  default=0.00)
...
class ShUserBalanceLog(AbstractModel):
    """ 用户余额变动表 """
    ...
    change_status = models.PositiveSmallIntegerField(
        choices=BalanceChangeStatus.choices, blank=True, null=True)
...
class ShShopAddress(AbstractModel):
    """ 收货地址 """
    owner = models.ForeignKey(User,
                              on_delete=models.CASCADE,
                              verbose_name="用户")
